...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Farthest layer. Converting VGG FCN (connected) to convolution layer (encoder)
    # num_classes is a binary classification - whether this pixel is a road or not
    # things to try - padding= 'same', kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3),
    ...
    # adding transpose layer for upscaling (decoder)
    # things to try - kernel_regularizer= tf.contrib.layers.l2_regularizer(1e-3),
    ...
    kernel_initializer=tf.truncated_normal_initializer(stddev=0.01), name='fcn_dconc_7')

    # Same as above for 4th layer
    ...
    # Adding skip layer for 4
    skip_layer_4 = tf.add(fcn_dconv_7, fcn_layer_4)

    # Same as above. Decoder for layer 4
    fcn_dconv_4 =tf.layers.conv2d_transpose(skip_layer_4, num_classes, kernel_size=4, strides=(2,2), padding='SAME', 
    kernel_initializer=tf.truncated_normal_initializer(stddev=0.01), name='fcn_dconv_4')    

    # Same as above, encoder for layer 3
    ...
    kernel_initializer=tf.truncated_normal_initializer(stddev=0.01), name='fcn_dconv_3')
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    for i in range(epochs):
        ...
        print("Epoch: {}/{} | Execution Time: {} sec | Loss: {:.3f}".format(i, epochs, train_time, loss))
